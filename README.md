...
- [HOW TO CONFIGURE TWO OR MORE SSH KEYS TO HAVE MULTIPLE GIT ACCOUNTS ON THE SAME COMPUTER? (WINDOWS, LINUX, AND MACOS)](#how-to-configure-two-or-more-ssh-keys-to-have-multiple-git-accounts-on-the-same-computer-windows-linux-and-macos)
  ...
  - [4. Organizing the Repositories :package:](#4-organizing-the-repositories-package)
    - [Important](#important)
    - [On Windows, Linux, and MacOS (same process)](#on-windows-linux-and-macos-same-process)
  ...
  - [6. Creating Configuration Files for Each Git Account :page\_with\_curl:](#6-creating-configuration-files-for-each-git-account-page_with_curl)
    - [On Windows, Linux, and MacOS (common part)](#on-windows-linux-and-macos-common-part)
  ...
  - [7. Creating the General Configuration File and Redirecting Git :link:](#7-creating-the-general-configuration-file-and-redirecting-git-link)
    - [On Windows, Linux, and MacOs (common part)](#on-windows-linux-and-macos-common-part-1)
    - [On Windows](#on-windows-2)
    - [On Linux and MacOs](#on-linux-and-macos-1)
  - [8. Copying the SSH Keys to Add Them to the Services :cloud:](#8-copying-the-ssh-keys-to-add-them-to-the-services-cloud)
    - [On Windows, Linux, and MacOs](#on-windows-linux-and-macos-1)
  ...
  - [10. Next Steps :rocket:](#10-next-steps-rocket)
    - [What’s this GPG key?](#whats-this-gpg-key)
    - [Advantages of Using GPG](#advantages-of-using-gpg)
